        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-16">
          <div className="col-span-1 md:col-span-2 space-y-8">
            ...
            <div className="flex gap-4">
              <Link to="#" className="text-slate-500 hover:text-orange-500 transition-colors p-2.5 bg-slate-900 hover:bg-orange-500/10 rounded-xl" aria-label="Twitter">
                <Twitter className="w-5 h-5" />
              </Link>
              <Link to="#" className="text-slate-500 hover:text-orange-500 transition-colors p-2.5 bg-slate-900 hover:bg-orange-500/10 rounded-xl" aria-label="LinkedIn">
                <Linkedin className="w-5 h-5" />
              </Link>
              <Link to="#" className="text-slate-500 hover:text-orange-500 transition-colors p-2.5 bg-slate-900 hover:bg-orange-500/10 rounded-xl" aria-label="GitHub">
