        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16">
          <div className="col-span-1 md:col-span-2 space-y-8">
            ...
            <p className="max-w-md text-base leading-relaxed">
              Milli Eğitim Bakanlığı standartlarına uygun, biyomedikal cihaz teknolojileri alanında uzmanlaşmak isteyen öğrenciler için geliştirilmiş modern bir eğitim portalı. Geleceğin sağlık teknolojilerini birlikte inşa ediyoruz.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium">
              ...
              <li><Link to="/blog" className="hover:text-teal-400 transition-colors">BCT Güncel Blog</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium">
              ...
              <li className="flex items-center gap-2 text-teal-500">
                ...
                <span>destek@bctogretmeni.com</span>
              </li>
            </ul>
          </div>
        </div>
