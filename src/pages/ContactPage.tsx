      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16">
          ...
          <div className="order-2 lg:order-1">
            {/* bg-slate-900/50 -> bg-card | border-white/5 -> border-border */}
            <Card className="border-none shadow-2xl bg-card/50 backdrop-blur-xl rounded-[2.5rem] border border-border transition-colors">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        // bg-slate-950/50 -> bg-muted/50 | text-white -> text-foreground
          ...
          <div className="order-1 lg:order-2 flex flex-col justify-between space-y-8">
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 gap-4">
                {[
                  ...
                  <div key={i} className="flex gap-5 items-start p-6 rounded-3xl border border-border bg-card/30 hover:bg-card/50 transition-all group">
            ...
            <div className="bg-muted rounded-[2.5rem] p-4 h-48 md:h-64 relative overflow-hidden border border-border shadow-inner group">
               ...
               {/* Gradient overlay uyumlu hale getirildi */}
