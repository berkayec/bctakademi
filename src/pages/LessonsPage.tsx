      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="space-y-12">
          ...
          <header className="text-center max-w-3xl mx-auto space-y-6">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed px-4 transition-colors">
            ...
            <div className="relative max-w-xl mx-auto pt-4 px-4">
              <div className="flex items-center relative group">
                <Search className="absolute left-7 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground group-focus-within:text-teal-500 transition-colors" />
                <Input
      ...
      {courses.map((course) => (
        ...
        <Card key={course.id} className="group flex flex-col h-full bg-card backdrop-blur-xl border-border rounded-[2.5rem] overflow-hidden hover:bg-card/80 transition-all duration-500 shadow-sm">
          ...
          <CardHeader className="p-8 pb-4">
            <CardTitle className="text-xl md:text-2xl font-bold text-foreground group-hover:text-teal-500 transition-colors leading-tight">
              {course.title}
            </CardTitle>
            <CardDescription className="text-muted-foreground text-sm leading-relaxed line-clamp-2 mt-2 transition-colors">
              {course.description}
            </CardDescription>
          </CardHeader>
          <CardFooter className="mt-auto p-8 pt-4">
            <Button variant="outline" className="w-full h-12 border-border text-foreground hover:bg-teal-500 hover:text-white hover:border-teal-500 font-bold rounded-xl transition-all" asChild>
