              ...
              <form onSubmit={handleSearch} className="relative group">
                ...
                <div className="relative flex p-1.5 bg-white rounded-2xl shadow-2xl">
                  ...
                  <Input
                    ...
                    className="h-14 pl-14 pr-4 border-none shadow-none text-slate-900 bg-transparent text-lg focus-visible:ring-0 w-full placeholder:text-slate-400"
                    value={searchValue}
                    onChange={(e) => setSearchValue(e.target.value)}
                  />
                  <Button type="submit" className="h-14 px-8 bg-slate-950 hover:bg-slate-900 text-white font-bold rounded-xl hidden sm:flex border-none">
                    Ara
                  </Button>
                </div>
              </form>
