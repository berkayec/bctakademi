    ...
    <RootLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        <header className="mb-16 space-y-4">
          ...
          <h1 className="text-4xl md:text-5xl font-display font-bold text-slate-900">BioMedTech Insights</h1>
          <p className="text-slate-600 text-lg max-w-2xl">
            Exploring breakthroughs, career guides, and technical deep-dives in the world of medical technology.
          </p>
        </header>
        {/* Featured Post */}
          ...
          >
            <div className="aspect-[16/10] lg:aspect-auto relative overflow-hidden">
              ...
              <div className="absolute top-6 left-6">
                <Badge className="bg-teal-500 text-white border-none px-4 py-1">Featured Article</Badge>
              </div>
            </div>
            <div className="p-8 md:p-12 flex flex-col justify-center space-y-6">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-bold text-slate-900 leading-tight group">
                {featuredPost.title}
              </h2>
              ...
              <Button className="w-fit bg-slate-900 hover:bg-orange-500 text-white rounded-xl px-8 py-6 h-auto text-base group">
                Read Article <ArrowRight className="ml-2 w-5 h-5 transition-transform group-hover:translate-x-1" />
              </Button>
            </div>
          </motion.div>
        </section>
            ...
            >
              ...
              <div className="flex-1 flex flex-col space-y-4">
                <div className="flex items-center justify-between">
                  <Badge variant="secondary" className="bg-slate-50 text-slate-600 hover:bg-teal-50 hover:text-teal-600 transition-colors">
                    {post.category}
                  </Badge>
                ...
                <h3 className="text-2xl font-display font-bold text-slate-900 group-hover:text-teal-600 transition-colors leading-tight">
                  {post.title}
                </h3>
                ...
                <div className="mt-auto pt-6 flex items-center justify-between">
                  <div className="flex items-center gap-2 text-xs font-semibold text-slate-900 uppercase">
                    Read More <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1 text-orange-500" />
                  </div>
