    ...
    <RootLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        <header className="mb-16 space-y-4 text-center md:text-left">
          ...
          <h1 className="text-4xl md:text-5xl font-display font-bold text-slate-900">BCT Güncel</h1>
        ...
        <section className="mb-20">
          ...
          >
            ...
            <div className="p-8 md:p-12 flex flex-col justify-center space-y-6">
              ...
              <Button className="w-fit bg-slate-900 hover:bg-orange-500 text-white rounded-xl px-8 py-6 h-auto text-base group transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {regularPosts.map((post) => (
            <motion.article key={post.id} whileHover={{ y: -6 }} className="group flex flex-col h-full bg-white">
