...
-- BCT Akademi statik içerik seed'i
-- curriculum.ts, data.ts verilerini D1'e aktarır
-- OR IGNORE: ikinci çalıştırmada çift kayıt olmaz

-- ─── KATEGORİLER ───────────────────────────────────────────────────────────
INSERT OR IGNORE INTO categories (id, title, sort_order, is_published) VALUES
  ('temel-dersler', 'Temel Dersler', 1, 1),
  ('alan-dersleri',  'Alan Dersleri',  2, 1);

-- ─── KURSLAR ───────────────────────────────────────────────────────────────
INSERT OR IGNORE INTO courses (id, category_id, title, description, image_url, sort_order, is_published) VALUES
  ('biyo-olcme', 'temel-dersler', 'Biyoölçme',
   ...
   'https://images.unsplash.com/photo-1516549655169-df83a0774514?auto=format&fit=crop&q=80&w=1200', 1, 1),

  ('biyoenstrumantasyon', 'temel-dersler', 'Biyoenstrümantasyon',
   'Biyomedikal sinyal işleme, operasyonel yükselteçler (Op-Amp) ve sensör teknolojilerinin mühendislik temelleri.',
   'https://images.unsplash.com/photo-1555664424-778a1e5e1b48?auto=format&fit=crop&q=80&w=1200', 2, 1),

  ('mesleki-fizyoloji-ve-terminoloji', 'temel-dersler', 'Mesleki Fizyoloji ve Terminoloji',
   'İnsan anatomisinin ve fizyolojik sistemlerin biyomedikal mühendislik perspektifiyle analizi.',
   'https://images.unsplash.com/photo-1530026405186-ed1f139313f8?auto=format&fit=crop&q=80&w=1200', 3, 1),

  ('teknik-resim', 'temel-dersler', 'Teknik Resim',
   'Biyomedikal cihaz tasarımı ve standart teknik çizim protokolleri.',
   'https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&q=80&w=1200', 4, 1),

  ('yasam-destek', 'alan-dersleri', 'Yaşam Destek Cihazları',
   'Ventilatör, defibrilatör, anestezi ve diyaliz sistemlerinin çalışma prensipleri ve arıza giderme yöntemleri.',
   'https://images.unsplash.com/photo-1581093588401-fbb62a02f120?auto=format&fit=crop&q=80&w=1200', 1, 1),

  ('biyomalzeme-biyomekanik', 'alan-dersleri', 'Biyomalzeme ve Biyomekanik',
   'Vücut içi implantlar, biyomalzeme sınıfları ve insan vücudunun mekanik analizleri.',
   'https://images.unsplash.com/photo-1576086213369-97a306dca664?auto=format&fit=crop&q=80&w=1200', 2, 1);

-- ─── ÜNİTELER ──────────────────────────────────────────────────────────────
INSERT OR IGNORE INTO units (id, course_id, title, description, estimated_reading_time, sort_order, is_published) VALUES
  -- Biyoölçme
  ('est-u-1', 'biyo-olcme', 'Ünite 1: İSG ve Laboratuvar Disiplini',
   'Biyomedikal teknik servislerde iş sağlığı, güvenliği ve profesyonel laboratuvar standartları.',
   '120 dk', 1, 1),
  ('est-u-2', 'biyo-olcme', 'Ünite 2: IEC 62353 Standartları',
   'Tıbbi cihazların periyodik bakımı ve onarım sonrası elektriksel güvenlik gereksinimleri.',
   '90 dk', 2, 1),
  ('est-u-3', 'biyo-olcme', 'Ünite 3: Kaçak Akım Ölçüm Teknikleri',
   'Farklı cihaz sınıflarında (Class I, II) kaçak akım ölçüm yöntemleri ve analizör kullanımı.',
   '110 dk', 3, 1),

  -- Biyoenstrümantasyon
  ('be-u-1', 'biyoenstrumantasyon', 'Ünite 1: Operasyonel Yükselteçler (Op-Amp)',
   'Biyopotansiyel sinyallerin yükseltilmesinde kullanılan temel devre elemanları.',
   '150 dk', 1, 1),
  ('be-u-2', 'biyoenstrumantasyon', 'Ünite 2: Aktif Filtreleme ve ADC',
   'Analog sinyallerin temizlenmesi ve dijitale aktarılması.',
   '120 dk', 2, 1),

  -- Mesleki Fizyoloji
  ('mf-u-1', 'mesleki-fizyoloji-ve-terminoloji', 'Ünite 1: Kardiyovasküler Sistem Dinamiği',
   'Kalbin elektriksel iletim sistemi ve hemodinamik parametreler.',
   '100 dk', 1, 1),
  ('mf-u-2', 'mesleki-fizyoloji-ve-terminoloji', 'Ünite 2: Sinir Sistemi ve Biyo-elektrik',
   'Nöronal iletim, aksiyon potansiyeli ve EEG temelleri.',
   '120 dk', 2, 1),

  -- Teknik Resim
  ('tr-u-1', 'teknik-resim', 'Ünite 1: Teknik Çizim Esasları',
   'Temel geometrik çizimler ve görünüş çıkarma teknikleri.',
   '60 dk', 1, 1),

  -- Yaşam Destek
  ('yd-u-1', 'yasam-destek', 'Ünite 1: Ventilatör Teknolojisi',
   'Mekanik ventilasyon modları, pnömatik devreler ve sensör kalibrasyonları.',
   '180 dk', 1, 1),
  ('yd-u-2', 'yasam-destek', 'Ünite 2: Defibrilasyon ve Kardiyoversiyon',
   'Elektro-şok cihazlarının çalışma prensibi ve enerji boşalma devreleri.',
   '140 dk', 2, 1),

  -- Biyomalzeme
  ('bm-u-1', 'biyomalzeme-biyomekanik', 'Ünite 1: Biyomalzeme Sınıflandırması',
   'Metaller, seramikler ve polimerlerin biyolojik uyumluluğu.',
   '90 dk', 1, 1);

-- ─── KONULAR ───────────────────────────────────────────────────────────────
INSERT OR IGNORE INTO topics (id, unit_id, title, content, video_youtube_id, sort_order, is_published) VALUES
  -- est-u-1
  ('est-t-1-1', 'est-u-1', 'Biyomedikalde Güvenlik Temelleri',
...
3. Antistatik zemin kaplaması.',
  ...
  ('est-t-1-2', 'est-u-1', 'Kişisel Koruyucu Donanım (KKD)',
...
-- ─── BLOG YAZILARI ─────────────────────────────────────────────────────────
INSERT OR IGNORE INTO blog_posts (id, title, excerpt, content, author, category, image_url, read_time, is_featured, is_published) VALUES
  ('post-1',
   ...
   'Biyomedikal Cihaz Teknolojileri alanında kariyer yapmak isteyenler için kapsamlı bir rehber. Lise döneminden başlayarak üniversite ve sonrasına uzanan bu yolculukta hangi becerileri geliştirmeniz gerektiğini, hangi sertifikaları almanız gerektiğini ve sektörün beklentilerini ele alıyoruz.',
   'Öğr. Gör. Mehmet Ak',
   'Kariyer',
  ...
  ('post-2',
   ...
   'Yapay zekanın tıbbi görüntüleme alanındaki devrim niteliğindeki uygulamaları. MRI ve BT cihazlarında AI destekli tanı sistemleri, radyolog iş akışlarının otomasyonu ve hasta sonuçlarının iyileştirilmesi üzerine kapsamlı bir analiz.',
   'Dr. Ayşe Yılmaz',
   'Teknoloji',
...
-- ─── KAYNAKLAR ─────────────────────────────────────────────────────────────
INSERT OR IGNORE INTO resources (id, title, description, type, category, file_size, duration, download_url, is_published) VALUES
  ('res-1',
